...
void analyze_SM( int sz, int szf, double tau, double g, double U ) {
  ...
  parlbm_SM<<<grid_spec, block_spec>>>(dfvals, dfvalsprev, dex, dey, g, tau, szf);
